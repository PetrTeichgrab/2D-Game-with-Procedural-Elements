...
//File taken from: https://www.youtube.com/watch?v=8Q2VwObN8mo&list=PLcRSafycjWFenI87z7uZHFv6cUG2Tzu9v&index=19&ab_channel=SunnyValleyStudio
public static class WallByteTypes
{
    ...
    public static HashSet<int> wallBottomCornerLeft = new HashSet<int>
    {
        0b1100
    };

    public static HashSet<int> wallBottomCornerRight = new HashSet<int>
    {
        0b1001,
        0b1001
    };
