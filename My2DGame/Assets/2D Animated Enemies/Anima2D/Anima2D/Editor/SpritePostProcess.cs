        ...
        static bool PostProcessSpriteMeshData(ISpriteEditorDataProvider spriteDataProvider, float definitionScale, Sprite[] sprites)
        {
            ...
            foreach (var sprite in sprites)
            {
                ...
                if (vertices.Length > 2 && indices.Length > 2)
                {
                    ...
                    var boneWeightArray = new NativeArray<UnityBoneWeight>(vertices.Length, Allocator.Temp);
                    ...
                    sprite.SetVertexAttribute<UnityBoneWeight>(VertexAttribute.BlendWeight, boneWeightArray);
                    vertexArray.Dispose();
                ...
                {
                    var boneWeightArray = new NativeArray<UnityBoneWeight>(sprite.GetVertexCount(), Allocator.Temp);
                    var defaultBoneWeight = new UnityBoneWeight() { weight0 = 1f };
